    ...
    <section id="campaign-planning" className="relative py-20 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="uppercase tracking-wide text-sm font-semibold text-[#5364FF]" data-aos="fade-up">
            Our Expertise
          </span>
          <h2
            data-aos="fade-up"
          ...
          >
            ...
            With <span className="text-[#5364FF] font-semibold">10+ years</span> of experience across 6 states, 
