...
const WhyChooseUs = () => {
  ...
  return (
    <section
      className="py-20 bg-gradient-to-b from-white to-[#f0f4ff]"
      id="why-choose-us"
    >
      <div className="max-w-7xl mx-auto px-6 text-center">
       
        <h2
          className="text-6xl font-bold text-[#5364FF] mb-4"
          data-aos="fade-up"
        >
        ...
        <p
          ...
          data-aos-delay="200"
        >
          We’re not just another PR agency — we’re your partners in building
          influence, winning trust, and creating impact. Our mix of experience,
          innovation, and grassroots connection makes us stand apart.
        </p>
