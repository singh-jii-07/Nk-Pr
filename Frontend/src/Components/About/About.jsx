    ...
    <section className="relative bg-white text-gray-800">
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="text-center mb-16" data-aos="fade-down">
          <span className="text-[#5364FF] font-bold uppercase tracking-wider">
            About Us
          </span>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          <div data-aos="fade-right">
            <h3 className="text-3xl font-bold mb-4 text-[#5364FF]">
              About the Company
            </h3>
            ...
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-3">
                <span className="text-[#5364FF] mt-1">✔</span>
                Over 50+ successful political campaigns managed
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#00F1FF] mt-1">✔</span>
                Strong presence across 6 states in India
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#FFAB3C] mt-1">✔</span>
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div
            ...
            data-aos="fade-up"
          >
            <div className="absolute inset-0 rounded-2xl border-2 border-[#5364FF]/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            <div className="flex items-center gap-4 mb-5">
              <div className="w-14 h-14 flex items-center justify-center rounded-full bg-[#5364FF]/10">
                <FaBullseye className="text-3xl text-[#5364FF]" />
              </div>
              <h3 className="text-2xl font-bold text-[#5364FF]">Our Mission</h3>
            </div>
          ...
          <div
            ...
            data-aos-delay="200"
          >
            <div className="absolute inset-0 rounded-2xl border-2 border-[#FFAB3C]/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            <div className="flex items-center gap-4 mb-5">
              <div className="w-14 h-14 flex items-center justify-center rounded-full bg-[#FFAB3C]/10">
                <FaEye className="text-3xl text-[#FFAB3C]" />
              </div>
              <h3 className="text-2xl font-bold text-[#FFAB3C]">Our Vision</h3>
            </div>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div
            ...
            data-aos-delay="400"
          >
            <div className="absolute inset-0 rounded-2xl border-2 border-[#16610E]/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            <div className="flex items-center gap-4 mb-5">
              <div className="w-14 h-14 flex items-center justify-center rounded-full bg-[#16610E]/10">
                <FaCheckCircle className="text-3xl text-[#16610E]" />
              </div>
              <h3 className="text-2xl font-bold text-[#16610E]">Our Values</h3>
            </div>
            <p className="text-gray-600 leading-relaxed">
